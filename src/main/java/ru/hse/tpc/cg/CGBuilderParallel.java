...
public class CGBuilderParallel implements CGBuilder {
    ...
    public CGBuilderParallel(ExecutorService executorService, int numWorkers, List<Transition> transitions) {
